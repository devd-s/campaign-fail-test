...
# Simple response models without Pydantic
...
@app.post("/campaigns/{campaign_id}/validate", response_model=CampaignValidationResponse)
...
@app.post("/campaigns/{campaign_id}/setup", response_model=CampaignSetupResponse)
